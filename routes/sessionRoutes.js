...
// If that function completes successfully (done(...) is called with no error argument),
// then it will redirect the page to the successRedirect page.
// If there is an error, then it will redirect to the failureRedirect page,
